...
def create_querytf_list(query_list):
	querytf_list = list()
	for query in query_list:
		...
		# create a dictionary for the term frequencies of the query
		querytf_dict = dict()
...
my_docs = create_docword_list(my_documents)
my_documenttf = create_documenttf_dict(my_docs)
my_querytf = create_querytf_list(my_queries)
